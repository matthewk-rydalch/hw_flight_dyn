...
class Compute_Models:
    ...
    def compute_tf_model(self, mav, trim_state, trim_input):
        ...
        #theta to delta_e
        self.a_th_1 = -rho*Va**2*c*S/(2.0*Jy)*C_m_q*c/(2.0*Va)
        ...
        #Va to delta_t
        self.a_v_1 = rho*Va_star*S/mass*(C_D_0+C_D_al*al_star+C_D_delta_e*delta_e_star)+rho*S_prop/mass*C_prop*Va_star
    ...
    def compute_ss_model(self, mav, trim_state, trim_input):
    ...
    def euler_state(self, x_quat):
        # convert state x with attitude represented by quaternion
        # to x_euler with attitude represented by Euler angles
         return x_euler

    def quaternion_state(self, x_euler):
        # convert state x_euler with attitude represented by Euler angles
        # to x_quat with attitude represented by quaternions
        return x_quat

    def f_euler(self, mav, x_euler, input):
        # return 12x1 dynamics (as if state were Euler state)
        # compute f at euler_state
        return f_euler_

    def df_dx(self, mav, x_euler, input):
        # take partial of f_euler with respect to x_euler
        return A

    def df_du(self, mav, x_euler, delta):
        # take partial of f_euler with respect to delta
        return B

    def dT_dVa(self, mav, Va, delta_t):
