...
Va_command = signals(dc_offset=25.0, amplitude=8.0, start_time=2.0, frequency = 0.05)
h_command = signals(dc_offset=100.0, amplitude=30.0, start_time=0.0, frequency = 0.02)
chi_command = signals(dc_offset=np.radians(0.0), amplitude=np.radians(200), start_time=5.0, frequency = 0.05)
